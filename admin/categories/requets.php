...
{
    // Utilisation de guillemets doubles pour délimiter la chaîne de caractères et concaténation des variables
    $sql = "SELECT * FROM `categories` LIMIT $offset,$limitLignesPage";
