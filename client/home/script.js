...
function showDetails(index) {
    ...
    var prix = document.getElementById('prix' + index);
    var image = document.getElementById('image' + index);
    var favoris = document.getElementById('heartIcon' + index);
    var panier = document.getElementById('panier' + index);
    ...
    favoris.style.transition = 'opacity 0.5s ease';
    panier.style.transition = 'opacity 0.5s ease';
    ...
    favoris.style.opacity = isVisible ? '0' : '1';
    panier.style.opacity = isVisible ? '0' : '1';
